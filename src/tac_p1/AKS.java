...
public class AKS extends Thread
{
    ...
    //If set to true, some progress messages will be printed
	static boolean verbose = false;
	
    //The number we are testing	
    BigInteger n;
    //Boolean indicating if the numer is prime or not
	boolean n_isprime;
...
//-----------------------------------------------------------------------------------------------a
	...
	public boolean isPrime() 
	{
        ...
        //OuterLoop T(n) = 3 + T(log()) + T(log(base)) + T(innerLoop) + T(conditionOut) 
        //+ I1 * (3 + T(log()) + T(log(base)) + T(innerLoop) 
        //+ T(conditionOut)) ---------------------------------------------------------------
		do
		{
			BigInteger result;
            ...
            //Condition T(conditionIf) = 1 + Max(T(then), T(else))
			if( comparison == 0 )
			{
                //T(then) = 3
